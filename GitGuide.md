...
Думаю, что название говорит само за себя. Это файл, который создается внутри папки проекта и в нем указываются папки, файлы, расширения, которые мы не хотим чтобы система git отслеживала.  
